...
def _catalyst_channel_memory_public_view(memory: dict | None, series_anchor_override: str = "") -> dict:
    ...
    public = {
        ...
        "operator_directive": _clip_text(str(data.get("operator_directive", "") or ""), 1600),
        "operator_mission": _clip_text(str(data.get("operator_mission", "") or ""), 320),
        "operator_summary": _clip_text(str(data.get("operator_summary", "") or ""), 320),
        "operator_guardrails": _dedupe_preserve_order(list(data.get("operator_guardrails") or []), max_items=10, max_chars=180),
        "operator_target_niches": _dedupe_preserve_order(list(data.get("operator_target_niches") or []), max_items=8, max_chars=80),
        "operator_apply_scope": str(data.get("operator_apply_scope", "") or ""),
        "operator_updated_at": float(data.get("operator_updated_at", 0.0) or 0.0),
