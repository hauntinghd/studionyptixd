...
CREATIVE_IMAGE_MODEL_PROFILES = [
    ...
    # Skeleton short-form direct path at backend.py:11805).
    {
        ...
        "provider": "xai",
        "tier": "basic",
        "summary": "xAI direct image lane for cleaner skeleton stills and thumbnails without fal spend.",
        "speed": "Fast",
        "credit_cost_per_image": 5,
        "estimated_unit_usd": 0.05,
        "billing_unit": "image",
    ...
    {
        "id": "grok_imagine_standard",
        "label": "Grok Imagine",
        "provider": "xai",
        "tier": "basic",
        "summary": "xAI standard image lane for lower-cost Grok still tests.",
        "speed": "Fast",
...
CREATIVE_VIDEO_MODEL_PROFILES = [
    ...
    },
    {
        ...
        "provider": "xai",
        "tier": "basic",
        "summary": "Low-cost xAI image-to-video lane. Best first test for cheaper short-form animation.",
        "speed": "Fast",
        "credit_multiplier": 1,
        "estimated_unit_usd": 0.05,
        "billing_unit": "second",
        "xai_model": "grok-imagine-video",
        "xai_resolution": "720p",
        "enabled": bool(XAI_API_KEY),
    },
    {
        ...
        "provider": "xai",
        "tier": "premium",
        "summary": "Higher-quality xAI image-to-video at 720p. Use when motion quality beats lowest cost.",
        "speed": "Balanced",
        "credit_multiplier": 3,
    ...
    },
    {
        ...
        "provider": "xai",
        "tier": "elite",
        "summary": "Highest-resolution xAI image-to-video lane for final hero exports only.",
        "speed": "Slow",
        "credit_multiplier": 5,
        "estimated_unit_usd": 0.25,
        "billing_unit": "second",
        "xai_model": "grok-imagine-video-1.5",
        "xai_resolution": "1080p",
        "enabled": bool(XAI_API_KEY),
    },
    {
        "id": "pixverse_v6",
