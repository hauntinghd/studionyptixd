---
name: gimp-image-editing
description: >-
  Stateful CLI for raster image editing via GIMP (layers, filters, canvas ops, text, compositing, export). Load when post-processing thumbnails, compositing elements, adding text overlays, adjusting colors, or any image manipulation beyond generation.
---
...
**Prerequisites:**
- Python 3.10+
- Pillow (`pip install cli-anything-gimp[pillow]`)
- numpy (needed for non-normal blend modes like multiply/screen/overlay)
