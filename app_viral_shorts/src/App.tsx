...
export default function App() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center pt-10 px-4 bg-gray-950">
            ...
            {/* Navigation */}
            <nav className="flex gap-2 p-1 bg-gray-900 rounded-xl mb-10 w-full max-w-4xl border border-gray-800">
                <button
                    onClick={() => setActiveTab('create')}
                    className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg font-medium transition-all ${activeTab === 'create' ? 'bg-indigo-600 shadow-lg text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
                >
                ...
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg font-medium transition-all ${activeTab === 'analyze' ? 'bg-indigo-600 shadow-lg text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
                >
                ...
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg font-medium transition-all ${activeTab === 'edit' ? 'bg-indigo-600 shadow-lg text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
                >
...
function AnalyzeTab() {
    return (
        <div className="bg-gray-900 p-8 rounded-2xl border border-gray-800 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-start justify-between mb-8">
                <div>
                    <h2 className="text-2xl font-bold">Success Analyzer</h2>
            ...
            <div className="border-2 border-dashed border-gray-700 rounded-xl p-10 text-center mb-8 hover:bg-gray-800/50 transition-colors cursor-pointer group">
                <UploadCloud className="w-12 h-12 mx-auto text-gray-500 group-hover:text-amber-400 transition-colors mb-4" />
                <p className="text-gray-300 font-medium">Upload Viral Short to Analyze</p>
            </div>
            ...
            <div className="p-6 bg-gray-950 rounded-xl border border-gray-800">
                ...
                <button className="px-6 py-2 bg-gray-800 hover:bg-emerald-600 hover:text-white border border-gray-700 font-medium rounded-lg transition-all" disabled>
                    Waiting for Video...
                </button>
            </div>
        </div>
...
function EditorTab() {
    return (
        <div className="bg-gray-900 p-8 rounded-2xl border border-gray-800 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-start justify-between mb-8">
                <div>
                    <h2 className="text-2xl font-bold">Pro-Gen AI Editor</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-gray-950 rounded-lg border border-gray-800">
                    <h4 className="font-medium text-white mb-2">Automated Tasks:</h4>
                    <ul className="text-sm text-gray-400 space-y-2">
                        <li>✓ Dynamic Auto-Framing</li>
                        <li>✓ Cinema-grade Color Grading</li>
                        <li>✓ Kinetic Typography Subtitles</li>
                        <li>✓ SFX & Audio Sweetening</li>
                    </ul>
                </div>
                <div className="p-4 bg-gray-950 rounded-lg border border-gray-800 flex flex-col justify-center items-center text-center">
                    <span className="text-3xl mb-2 font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-indigo-500">Level 10</span>
                    <span className="text-xs text-gray-500 uppercase tracking-wider">Agency Quality</span>
                </div>
            </div>

            <button className="w-full mt-6 bg-gradient-to-r from-pink-600 to-indigo-600 hover:from-pink-500 hover:to-indigo-500 text-white font-bold py-4 rounded-xl shadow-lg transition-transform active:scale-[0.98]">
                Start Magical Edit
            </button>
        </div>
    );
