...
export const PUBLIC_PLAN_FEATURES_FALLBACK: PlanFeatureMap = {
    creator: ['studio_agent', 'anthropic_runner', 'fal_media'],
    studio: ['studio_agent', 'anthropic_runner', 'fal_media', 'priority_queue'],
    studio_pro_1k: ['studio_agent', 'anthropic_runner', 'fal_media'],
    studio_pro_2500: ['studio_agent', 'anthropic_runner', 'fal_media'],
    studio_pro_5k: ['studio_agent', 'anthropic_runner', 'fal_media', 'priority_queue'],
    studio_pro_11k: ['studio_agent', 'anthropic_runner', 'fal_media', 'priority_queue'],
    studio_pro_17k: ['studio_agent', 'anthropic_runner', 'fal_media', 'priority_queue'],
    studio_pro_24k: ['studio_agent', 'anthropic_runner', 'fal_media', 'priority_queue'],
    studio_pro_32k: ['studio_agent', 'anthropic_runner', 'fal_media', 'priority_queue'],
    studio_pro_2k: ['studio_agent', 'anthropic_runner', 'fal_media'],
    studio_pro_8k: ['studio_agent', 'anthropic_runner', 'fal_media', 'priority_queue'],
    studio_pro_15k: ['studio_agent', 'anthropic_runner', 'fal_media', 'priority_queue'],
};
